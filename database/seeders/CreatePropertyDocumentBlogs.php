...
use App\Support\PropertyDocumentBlogBuilder;
use Illuminate\Database\Seeder;

class CreatePropertyDocumentBlogs extends Seeder
{
    public function run(): void
    {
        ...
        foreach (PropertyDocumentBlogBuilder::definitions() as $definition) {
            $content = PropertyDocumentBlogBuilder::build($definition);
