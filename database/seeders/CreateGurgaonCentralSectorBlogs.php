...
use App\Support\GurgaonCentralSectorBlogBuilder;
use Illuminate\Database\Seeder;

class CreateGurgaonCentralSectorBlogs extends Seeder
{
    public function run(): void
    {
        ...
        foreach (GurgaonCentralSectorBlogBuilder::definitions() as $definition) {
            $content = GurgaonCentralSectorBlogBuilder::build($definition);
