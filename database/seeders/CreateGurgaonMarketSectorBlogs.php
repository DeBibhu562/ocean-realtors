...
use App\Support\GurgaonMarketSectorBlogBuilder;
use Illuminate\Database\Seeder;

class CreateGurgaonMarketSectorBlogs extends Seeder
{
    public function run(): void
    {
        ...
        foreach (GurgaonMarketSectorBlogBuilder::definitions() as $definition) {
            $content = GurgaonMarketSectorBlogBuilder::build($definition);
