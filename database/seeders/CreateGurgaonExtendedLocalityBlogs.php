...
use App\Support\GurgaonExtendedLocalityBlogBuilder;
use Illuminate\Database\Seeder;

class CreateGurgaonExtendedLocalityBlogs extends Seeder
{
    public function run(): void
    {
        ...
        foreach (GurgaonExtendedLocalityBlogBuilder::definitions() as $definition) {
            $content = GurgaonExtendedLocalityBlogBuilder::build($definition);
