...
use App\Support\GurgaonCorridorBlogBuilder;
use Illuminate\Database\Seeder;

class CreateGurgaonCorridorInvestmentBlogs extends Seeder
{
    public function run(): void
    {
        ...
        foreach (GurgaonCorridorBlogBuilder::definitions() as $definition) {
            $content = GurgaonCorridorBlogBuilder::build($definition);
