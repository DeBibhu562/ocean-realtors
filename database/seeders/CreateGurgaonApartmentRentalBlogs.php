...
use App\Support\GurgaonApartmentRentalBlogBuilder;
use Illuminate\Database\Seeder;

class CreateGurgaonApartmentRentalBlogs extends Seeder
{
    public function run(): void
    {
        ...
        foreach (GurgaonApartmentRentalBlogBuilder::definitions() as $definition) {
            $content = GurgaonApartmentRentalBlogBuilder::build($definition);
